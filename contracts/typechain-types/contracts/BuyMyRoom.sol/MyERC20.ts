...
export interface MyERC20Interface extends utils.Interface {
  functions: {
    ...
    "convertEthToErc20()": FunctionFragment;
    ...
    "trans(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "convertEthToErc20",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "trans", data: BytesLike): Result;
...
export interface MyERC20 extends BaseContract {
  ...
  callStatic: {
    ...
    convertEthToErc20(overrides?: CallOverrides): Promise<void>;
